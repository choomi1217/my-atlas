...
class ProductControllerTest {
    ...
    void listByCompany_returnsOk() throws Exception {
        ...
        List<ProductDto.ProductResponse> products = List.of(
                new ProductDto.ProductResponse(1L, 10L, "Web App", Platform.WEB, "Main app", null, null, ExecTargetKind.WEB, now),
                new ProductDto.ProductResponse(2L, 10L, "Mobile App", Platform.MOBILE, null, null, null, ExecTargetKind.WEB, now)
        );
    ...
    void create_returns201() throws Exception {
        ...
        ProductDto.ProductResponse created = new ProductDto.ProductResponse(
                1L, 10L, "New Product", Platform.WEB, "A web product", null, null, ExecTargetKind.WEB, now);
    ...
    void update_returnsOk() throws Exception {
        ...
        ProductDto.ProductResponse updated = new ProductDto.ProductResponse(
                1L, 10L, "Updated Product", Platform.DESKTOP, "Updated desc", null, null, ExecTargetKind.WEB, now);
