...
class ProductServiceImplTest {
    ...
    void setUp() {
        ...
        product1 = new ProductEntity(1L, company, "Product A", Platform.WEB, "Web app", null, null, null, ExecTargetKind.WEB, LocalDateTime.now());
        product2 = new ProductEntity(2L, company, "Product B", Platform.MOBILE, "Mobile app", null, null, null, ExecTargetKind.WEB, LocalDateTime.now());
    }
