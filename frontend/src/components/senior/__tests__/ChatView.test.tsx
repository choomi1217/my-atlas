...
describe('ChatView', () => {
  ...
  it('shows FAQ context banner', () => {
    const faqContext = { id: 1, title: 'Login FAQ', content: 'Content', category: null, tags: null, source: null, hitCount: 0, pinnedAt: null, createdAt: '2026-03-26', updatedAt: '2026-03-26' };
