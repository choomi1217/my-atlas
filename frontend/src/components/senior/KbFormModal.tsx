...
interface KbFormModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSubmit: (request: KbRequest) => Promise<void>;
  editItem?: KbItem | null;
}

export default function KbFormModal({ isOpen, onClose, onSubmit, editItem }: KbFormModalProps) {
        ...
        <form onSubmit={handleSubmit}>
          <div className="px-6 py-4 border-b border-gray-200">
            <h3 className="text-lg font-semibold text-gray-800">
              {editItem ? 'Edit KB Entry' : 'Create KB Entry'}
            </h3>
          </div>
